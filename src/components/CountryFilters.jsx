...
const CountryFilters = ({ countries, setFilteredCountries }) => {
  ...
  return (
    <div className="mb-6 space-y-4 md:space-y-0 md:flex md:flex-wrap md:items-center md:justify-between">
      <input
        type="text"
        placeholder="Buscar pelo nome do país"
        value={searchTerm}
        onChange={handleSearchChange}
        className="w-full md:w-64 border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
      <select value={region} onChange={handleRegionChange} className="w-full md:w-auto mt-2 md:mt-0 border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <select value={sortDirection} onChange={handleSortDirectionChange} className="w-full md:w-auto mt-2 md:mt-0 border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
